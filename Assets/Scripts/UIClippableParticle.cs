...
public class UIClippableParticle : UIBehaviour, IClippable {
	...
	public void Cull (Rect clipRect, bool validRect)
	{
		...
		if (validRect)
			ParticleRenderer.material.EnableKeyword("UNITY_UI_MASKCLIP");
		else
			ParticleRenderer.material.DisableKeyword("UNITY_UI_MASKCLIP");
		...
		ParticleRenderer.sharedMaterial.SetVector("_ClipRect", vec);
	}
